...
public class HttpConsumerTest {
    ...
    public static void main(String[] args) {
        ...
        // 您在控制台创建的 Group ID
        final String groupId = "GID_http_demo";
        // Topic所属实例ID，默认实例为空
        ...
        do {
            ...
            try {
                ...
                messages = consumer.consumeMessage(3, // 一次最多消费3条(最多可设置为16条)
                        3// 长轮询时间3秒（最多可设置为30秒）
                );
            } catch (Throwable e) {
                e.printStackTrace();
                    ...
                    if (e instanceof AckMessageException) {
                        ...
                        if (errors.getErrorMessages() != null) {
                            for (String errorHandle : errors.getErrorMessages().keySet()) {
                                System.out
                                        .println("Handle:" + errorHandle + ", ErrorCode:" + errors.getErrorMessages().get(errorHandle).getErrorCode()
